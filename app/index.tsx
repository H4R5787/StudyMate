...
//         <ActionButton color="#4361ee" onPress={() => navigation.navigate("/Auth")}>Get Started</ActionButton>

//         <TouchableOpacity style={{ marginTop: 15 }} onPress={() => navigation.navigate("dashboard")}>
